...
let
  baseData = {
    next = {
      rev = "030905368a4ab507c60f51f4b5109c6b0a3cd378";
      hash = "sha256-th1oKeZfdALqgKLOckcvp2ZzSlg95pqkHBwlIDavBMA=";
      version = "2.52.0.rc2.441.g030905368a";
    ...
    master = {
      rev = "99bd5a5c9f74abfe81196d96b8467d0d1d4723c5";
      hash = "sha256-bb8JFT5OQ+K6V2x3hgUbDuPgM9XFCRB2sM4XeJGDlEE=";
      version = "2.52.0.rc2.2.g99bd5a5c9f";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
