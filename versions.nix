...
let
  baseData = {
    next = {
      rev = "c1ab5b90caafe0e01395e0937868c10fd1c06ddf";
      hash = "sha256-NIELLRF852TkolCAwP10AuOs+06mNJMxNdN9G4v+ha4=";
      version = "2.51.2.1041.gc1ab5b90ca";
    ...
    master = {
      rev = "a99f379adf116d53eb11957af5bab5214915f91d";
      hash = "sha256-LRc/KowEmAPZDNaM3wlgMNfFmPFq9A97cCYdMw16d2w=";
      version = "2.51.2.636.ga99f379adf";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
