...
let
  baseData = {
    next = {
      rev = "0dd7633a2946b0a81005396ea3435e2932f0d2de";
      hash = "sha256-snbg+1k9zWkjSf50KUnT69gr9sKV7b+86blyI3zfGGQ=";
      version = "2.52.0.358.g0dd7633a29";
    ...
    master = {
      rev = "e7ef0ca622016d12a85836928a03959de4537c2f";
      hash = "sha256-s6EcT6R/jsJ1gj7Plu5+1ammQ0ImovlnmOdaJJRBpTU=";
      version = "2.52.0.260.ge7ef0ca622";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
