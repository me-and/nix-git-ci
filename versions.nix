...
let
  baseData = {
    next = {
      rev = "674ac2bdf7c6f0d156df6d082f5137cb019b8bec";
      hash = "sha256-CScgwQjmCSRwFXk6g2aSVxnzO4SmAjNNl5VdRIx/400=";
      version = "2.52.0.313.g674ac2bdf7";
    ...
    master = {
      rev = "e85ae279b0d58edc2f4c3fd5ac391b51e1223985";
      hash = "sha256-4oq5p2vvih0gBJWMzn8Z43LwQdYOaNV/JFjxSKL1bHs=";
      version = "2.52.0.209.ge85ae279b0";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
