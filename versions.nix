...
let
  baseData = {
    next = {
      rev = "68957de207161575e953b9f05d9ab0318f2327d9";
      hash = "sha256-Xi/YsoA7wBgT38ak2Hxw3YiE1KGjEeISNmF1emxK3uw=";
      version = "2.52.0.rc1.443.g68957de207";
    ...
    master = {
      rev = "4badef0c3503dc29059d678abba7fac0f042bc84";
      hash = "sha256-FZAFRKVNreT+TdKSM+bPvqtyQoI837b2KROMokxPajM=";
      version = "2.52.0.rc1.17.g4badef0c35";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
