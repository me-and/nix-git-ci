...
let
  ...
  baseData = {
    next = {
      rev = "0fbf48f4d677e51545ea17db7c7063932ee42087";
      hash = "sha256-RDjrz2S1fSVvZUJJcekLO6MBQiMoE94pVgDPngROOI0=";
      version = "2.54.0.rc1.526.g0fbf48f4d6";
    ...
    master = {
      rev = "cd412a49627774a14b3e49237109a77bd3ea70c0";
      hash = "sha256-2KGpQmMFVlcyrfXgdhqVy1RKph8i/eTk8Qq5dZTCAI0=";
      version = "2.54.0.rc1.59.gcd412a4962";
