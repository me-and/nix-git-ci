...
let
  baseData = {
    next = {
      rev = "6d19910ace457d928b37f6ca7c496d4fd04f3edd";
      hash = "sha256-cJvnwg/CeJrGoZOIqBngD0cE3RsiYqnOLNDxrmhb/4c=";
      version = "2.51.0.788.g6d19910ace";
    ...
    master = {
      rev = "60f3f52f17cceefa5299709b189ce6fe2d181e7b";
      hash = "sha256-zuuQSzBe/6jbWads14sMQ4rhkHvnZ8Shzf7pfPpEhq8=";
      version = "2.51.0.480.g60f3f52f17";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
