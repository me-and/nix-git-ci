...
let
  ...
  baseData = {
    next = {
      rev = "5766caf01e1fda2cd21c177fa4056f150dca619c";
      hash = "sha256-qyKzcJ1T8sOCX0fL4cFvH0t1Id7LkThkWsXQyMYKEIY=";
      version = "2.54.0.rc0.581.g5766caf01e";
    ...
    master = {
      rev = "8de2f1b07a8053d7f1aad70dc1131d6afcf5a28a";
      hash = "sha256-PjeMlxWj2md1w3wissSlfUMaMub4qvkfn4IacCsUHwo=";
      version = "2.54.0.rc0.52.g8de2f1b07a";
