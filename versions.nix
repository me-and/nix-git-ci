...
let
  baseData = {
    next = {
      rev = "f5cc29aaa48b979583a3fbe972e9795efbe8d134";
      hash = "sha256-Lu+zyxA5vwOBV8b2VkqNlKRsLmrrX2J+LuM4yfJ4Ss0=";
      version = "2.52.0.223.gf5cc29aaa4";
    ...
    master = {
      rev = "f0ef5b6d9bcc258e4cbef93839d1b7465d5212b9";
      hash = "sha256-sX6Bgkhpa5MYOS4MQ+P97As3c8nZwb0feCY6zntc2K8=";
      version = "2.52.0.154.gf0ef5b6d9b";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
