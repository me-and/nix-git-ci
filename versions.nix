...
let
  baseData = {
    next = {
      rev = "07c0f32ad777c2fac492a072e15e81ab81735b0e";
      hash = "sha256-17muHNr3WrPTx/qLAmPlyj0d2wvw4/g5to9TDjIV8CI=";
      version = "2.52.0.rc0.459.g07c0f32ad7";
    ...
    master = {
      rev = "4cf919bd7b946477798af5414a371b23fd68bf93";
      hash = "sha256-cyKHPYcJea1rL+eEnYyHq4Rw5S5v7MTozEuPw2XCSnc=";
      version = "2.52.0.rc0.28.g4cf919bd7b";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
