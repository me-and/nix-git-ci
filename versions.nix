...
let
  baseData = {
    next = {
      rev = "e66316f0416ef743a7482d09dea39cf8fae0e6fd";
      hash = "sha256-r4HYhSyAgI4yKjblgXTov89VhxWgvd86CJG+5rxF1wI=";
      version = "2.51.0.869.ge66316f041";
    ...
    master = {
      rev = "4b71b294773cc4f7fe48ec3a70079aa8783f373d";
      hash = "sha256-VhNfkuKAYltZvqyBhKwbFx/tD4p9mJfF79WzQEUAmpM=";
      version = "2.51.0.491.g4b71b29477";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
