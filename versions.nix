{
  next = {
    rev = "83e99ddf4094f2c040378c609fcafe6bcce232da";
    hash = "sha256-UXfQu/85bs4YYIK2RlpxaAinplKFjZ5V8bowM6G24i4=";
    version = "2.50.0.203.g83e99ddf40";
  ...
  master = {
    rev = "83014dc05f6fc9275c0a02886cb428805abaf9e5";
    hash = "sha256-m4l5UWQ+NBIwZbh9/zN6ge3rCWY9D3YfQHU0NdZuImw=";
    version = "2.50.0.145.g83014dc05f";
    extraOverride = prevAttrs: {
      patches = map (
        p:
        if baseNameOf p == "git-send-email-honor-PATH.patch" then
