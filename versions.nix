...
let
  ...
  baseData = {
    next = {
      rev = "2a3d6836805534f45cf545da7be25ce1c759c514";
      hash = "sha256-0BQ+H0yfJhYaMW0XRpMib0zTV2Ay7Go24GiIg+bsSNk=";
      version = "2.53.0.273.g2a3d683680";
    ...
    master = {
      rev = "3e0db84c88c57e70ac8be8c196dfa92c5d656fbc";
      hash = "sha256-SjhG3WBeE57bCzu5P+xqUt+dy2+6yInLuWMZZ6MkBRg=";
      version = "2.53.0.40.g3e0db84c88";
