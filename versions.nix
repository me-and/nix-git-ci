...
let
  baseData = {
    next = {
      rev = "a50a493c49d755bf293be8b21ea65208572816ae";
      hash = "sha256-ynyXvsXTrk7TLJmawmlpGJN4RBiaV3id5583dl7S14k=";
      version = "2.51.2.1006.ga50a493c49";
    ...
    master = {
      rev = "57da342c786f59eaeb436c18635cc1c7597733d9";
      hash = "sha256-5ZPh7Aop4IOUfthzZ6X4RZ14dqRdAb/mWDsxgH0uKwM=";
      version = "2.51.2.560.g57da342c78";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
