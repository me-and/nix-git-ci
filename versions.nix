...
let
  baseData = {
    next = {
      rev = "89d9e04f91292258263fb94060e466f84fbfc9d4";
      hash = "sha256-xfbK0KfXSLfQY5mumhjdjbMEm38hM25HE00nnLqlnsw=";
      version = "2.52.0.121.g89d9e04f91";
    ...
    master = {
      rev = "debbc87557487aa9a8ed8a35367d17f8b4081c76";
      hash = "sha256-R7NUSGsEP3Ue704TDSNsLMWBcbnz+4bZZHgPkDvDUZs=";
      version = "2.52.0.51.gdebbc87557";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
