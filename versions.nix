...
let
  baseData = {
    next = {
      rev = "230fcf2819a6e6e5372cd128168db10ebbe23885";
      hash = "sha256-gIJN+vmuzAM9eLBZWT6dKacYxocM+43W5rcuZ4V0NmM=";
      version = "2.52.0.rc2.455.g230fcf2819";
    ...
    master = {
      rev = "c93f1a0fa3eb0a943f4cc2262de1832c9a3aa1e2";
      hash = "sha256-yp3MsyZHkYN0ozEVhYqR0RMwpVwGkwFk87y1nRvtckE=";
      version = "2.52.0.rc2.22.gc93f1a0fa3";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
