...
let
  baseData = {
    next = {
      rev = "1a473401a441c9792ef9f67429f75d1bcd95baa2";
      hash = "sha256-ienZtXtZ8GNg9NEvA/BahxS6+C0JO6v6VPYS3TctK/A=";
      version = "2.51.0.422.g1a473401a4";
    ...
    master = {
      rev = "4975ec3473b4bc61bc8a3df1ef29d0b7e7959e87";
      hash = "sha256-Tdf2s8ULyfB/SDLBD8iJAOvZCr9PWXQBro3cjd6k2Iw=";
      version = "2.51.0.193.g4975ec3473";
      extraOverride = prevAttrs: {
        patches = map (
          p:
          if baseNameOf p == "git-send-email-honor-PATH.patch" then
