...
let
  baseData = {
    next = {
      rev = "19442a804edf2a72e573d3ee6cf69193a1291c94";
      hash = "sha256-toLyJfABWIeGSYRXXAruL4VSCU4pnCiz+grhKRqjXn4=";
      version = "2.51.1.838.g19442a804e";
    ...
    master = {
      rev = "133d151831d32bdcc02422599a3f26cef44f929b";
      hash = "sha256-ux47SiyA3OXrry/JXDt2oTIPh4bymGPlQiz4+TVu0gQ=";
      version = "2.51.1.500.g133d151831";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
