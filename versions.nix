...
let
  allVersions = {
    next = {
      rev = "393fa4b64b12da3d3fdcefb02739bb1e82291dcc";
      hash = "sha256-AoHX4/0oS6qmoYIZ6gwmg+wtDFzVKKOm+s1OaMM8RSc=";
      version = "2.50.1.661.g393fa4b64b";
    ...
    master = {
      rev = "e813a0200a7121b97fec535f0d0b460b0a33356c";
      hash = "sha256-RAmxPSqS8cXwWva0zi8T4QZKq2yeaHUp1/62NBns0nw=";
      version = "2.50.1.469.ge813a0200a";
      extraOverride = prevAttrs: {
        patches = map (
          p:
          if baseNameOf p == "git-send-email-honor-PATH.patch" then
