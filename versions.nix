...
let
  ...
  baseData = {
    next = {
      rev = "c82f188059a6ca12355cd6ca567c0dcd507f510f";
      hash = "sha256-yI10SGCDcTQZ7Z8lTp1KPxZ2m885m71afFVy+ihuhOw=";
      version = "2.54.0";
    ...
    master = {
      rev = "6a4418c36d6bad69a599044b3cf49dcbd049cb45";
      hash = "sha256-HYLVb/ziXX6zYJN9iIc2wIykbyBB939sHscsIG8w9rQ=";
      version = "2.54.0";
