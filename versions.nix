{
  next = {
    rev = "b486b64238e9a587c8c2906384c408ecf1c55882";
    hash = "sha256-0YMzj06446amO91I6WfNicwxSWerBlcr68SGY3cdar0=";
    version = "2.50.0.189.gb486b64238";
  ...
  master = {
    rev = "f0135a9047ca37d4d117dcf21f7e3e89fad85d00";
    hash = "sha256-lblxFFIgS4ZcFpxlzVBLvryrAjvNZ8l4fhMpDu/Q6fc=";
    version = "2.50.0.106.gf0135a9047";
    extraOverride = prevAttrs: {
      patches = map (
        p:
        if baseNameOf p == "git-send-email-honor-PATH.patch" then
