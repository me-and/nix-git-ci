...
let
  baseData = {
    next = {
      rev = "61a8936c2151ce465d7d3286fe1d38bfb821753f";
      hash = "sha256-gLBoEVZ+CUfa0WPEIYEXnDJ5Jfkxio5RR2MQ46xfBnY=";
      version = "2.51.0.915.g61a8936c21";
    ...
    master = {
      rev = "b660e2dcb98ed4eafe2781b7ba31b70d2fcbad80";
      hash = "sha256-Nw3RR5PH1SLJwAVj9cagIsfrS1xPo1aD7YO7BFPGFnU=";
      version = "2.51.0.573.gb660e2dcb9";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
