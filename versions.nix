...
let
  ...
  baseData = {
    next = {
      rev = "872841220f6fa6fb337b4600d44f8db32b9ac95f";
      hash = "sha256-m+oK+6aWiOhWvsfZJPfU1IF88gRFkkywZdO7eJeQygw=";
      version = "2.53.0.756.g872841220f";
    ...
    master = {
      rev = "628a66ccf68d141d57d06e100c3514a54b31d6b7";
      hash = "sha256-Aj9iGzGgymy8n42PrcLvOsLjmV4RWw55KeJAElZPbII=";
      version = "2.53.0.381.g628a66ccf6";
