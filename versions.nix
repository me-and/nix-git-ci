...
let
  allVersions = {
    next = {
      rev = "924127e9c014b3ea7c2d50fa2a4da7e6f0b155c5";
      hash = "sha256-H7aJ8SBCgPI1J/nt0NLHdYMeiywKbyEKIFchX/qipXc=";
      version = "2.51.0.rc1.167.g924127e9c0";
    ...
    master = {
      rev = "2c2ba49d55ff26c1082b8137b1ec5eeccb4337d1";
      hash = "sha256-pBy1cxSDnxq/q84uZIh5YvUIwsRce9rnFBryFi4wzYE=";
      version = "2.51.0.rc1";
      extraOverride = prevAttrs: {
        patches = map (
          p:
