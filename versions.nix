...
let
  baseData = {
    next = {
      rev = "07681ecd9b0a321cb12a8cb18dac6580ede927c4";
      hash = "sha256-iMbCb71nwziKROJFJBBNJgyVcSN1brSWQ9z2Tih78SQ=";
      version = "2.51.0.507.g07681ecd9b";
    ...
    master = {
      rev = "a483264b01b977f3e65a4419103c21e6af7412a2";
      hash = "sha256-lleQBqQQHn5UHfHJQ7TWa3muO77P4eZLD+xiQPXUSgo=";
      version = "2.51.0.268.ga483264b01";
      extraOverride = prevAttrs: {
        patches = map (
          p:
          if baseNameOf p == "git-send-email-honor-PATH.patch" then
