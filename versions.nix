...
let
  ...
  baseData = {
    next = {
      rev = "eaeac8ef83491e77f95ff77760b5e67993f37d8d";
      hash = "sha256-zb48gtI5oj9ksTZRI6e46gFw7UqIwYS4jyd4wLtZNWk=";
      version = "2.54.0.rc0.680.geaeac8ef83";
    ...
    master = {
      rev = "7c4e9e957a427d4c6a19265a528de0a161ff9b62";
      hash = "sha256-UPgf49fnmW4M0F/LXHCX5lZTsY8McSSISLj2abjlcEI=";
      version = "2.54.0.rc0.180.g7c4e9e957a";
