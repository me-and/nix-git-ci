...
let
  baseData = {
    next = {
      rev = "38ec6c3e3b6da97b0b11a99adc78c386d413d9d8";
      hash = "sha256-7MN2llAGfe5bIt/JkliCKAsiQTZ50PcByUeo6KpIIa8=";
      version = "2.51.2.995.g38ec6c3e3b";
    ...
    master = {
      rev = "419c72cb8ada252b260efc38ff91fe201de7c8c3";
      hash = "sha256-qD3sbWHyRKZ2g5GiMlc89u2uz9X6k6DWUSSFE6lWHJQ=";
      version = "2.51.2.535.g419c72cb8a";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
