...
let
  ...
  baseData = {
    next = {
      rev = "91e22a74dc796bb45da20876fba19a457fcf39ff";
      hash = "sha256-72KMVnbMy2TKh1uT7T0B+uzOVDwX8aoug+dm5laINgg=";
      version = "2.54.0.rc0.545.g91e22a74dc";
    ...
    master = {
      rev = "256554692df0685b45e60778b08802b720880c50";
      hash = "sha256-hFutMH9+AzxbBMdt12gStJtlCaFH6esilrbbg7AZPIQ=";
      version = "2.54.0.rc0";
