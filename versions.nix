...
let
  baseData = {
    next = {
      rev = "91966686e1fca052b37d9d7ffe980480ae4e93d4";
      hash = "sha256-tqMEFn1ETLPN/IFFRGt/2U3k8Ek7KkMxzvnHEsDaK8g=";
      version = "2.51.0.877.g91966686e1";
    ...
    master = {
      rev = "ac7d021f0659f5a81be7b69a54a19c9618ce9dba";
      hash = "sha256-6/KY4rstOJUq87+ubm5Nad3U814x00WZ1mljC1pkaF4=";
      version = "2.51.0.511.gac7d021f06";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
    ...
    "maint-2.51" = {
      rev = "dba6e578b68488823490130637c6f4755938c518";
      hash = "sha256-ey3KatKfZEUnQ5A49b+7Ca5/rRLJ63IzbaoLyJSEmlI=";
      version = "2.51.0.41.gdba6e578b6";
      extraOverride = prevAttrs: {
        patches = map (
          p:
          if baseNameOf p == "git-send-email-honor-PATH.patch" then
