...
let
  baseData = {
    next = {
      rev = "e8671fe553c8b23de1b9a0f494eb2b7ff9064e62";
      hash = "sha256-1POk695WuHtwpXW9PEImbcH1juP89ZenlKv9NwyO05o=";
      version = "2.51.0.734.ge8671fe553";
    ...
    master = {
      rev = "5099f64a82ccc80f3c6567589bfeb5e9a1b9fd6b";
      hash = "sha256-wNcvN85qVW0AW99YZO0af4pJ2Y9J4NyBMWQ6AkG9xlk=";
      version = "2.51.0.414.g5099f64a82";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
