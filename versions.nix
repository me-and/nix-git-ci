...
let
  allVersions = {
    next = {
      rev = "ee6f71324cf4b17de43e47e490fe0d56f2b4b7df";
      hash = "sha256-vgOeFKgbRBElrm2KPbCcSX5S/UguQOO14rKVfb6ty74=";
      version = "2.50.1.441.gee6f71324c";
    ...
    master = {
      rev = "32571a0222eb85ef265e136f27e44c302302b45c";
      hash = "sha256-626tr8INqHUlQ7qujmdRmx0iEBj85AFCj/WKUqEqzE4=";
      version = "2.50.1.294.g32571a0222";
      extraOverride = prevAttrs: {
        patches = map (
          p:
          if baseNameOf p == "git-send-email-honor-PATH.patch" then
