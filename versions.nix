...
let
  baseData = {
    next = {
      rev = "b8fa24458fcebbf9b6c96841d6e1f769d3f451ce";
      hash = "sha256-ouuteYlTmiw70R43yXccL/lribIjSxoQMolnqGYMJoQ=";
      version = "2.51.1.814.gb8fa24458f";
    ...
    master = {
      rev = "143f58ef7535f8f8a80d810768a18bdf3807de26";
      hash = "sha256-1lZ2etJw7WA+GJ+PWTA+7cJC3FhJyb3OQpe412LLbqY=";
      version = "2.51.1.471.g143f58ef75";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
