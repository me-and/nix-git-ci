...
let
  baseData = {
    next = {
      rev = "de9c8c526cb441e136815397089584f539713c71";
      hash = "sha256-qg+ypdU9sg64zvwDI0/4uA4oGLOiKZHcZSQgXfVEq4M=";
      version = "2.51.0.667.gde9c8c526c";
    ...
    master = {
      rev = "821f583da6d30a84249f75f33501504d597bc16b";
      hash = "sha256-hy6g2V6a2uaIELqC/ZB0MBp/3GTvXw8dl89/Cj2cXlY=";
      version = "2.51.0.372.g821f583da6";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
