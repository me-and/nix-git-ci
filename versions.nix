...
let
  allVersions = {
    next = {
      rev = "c32cd1483be90fa6182845f8d9c0c74dc287cc37";
      hash = "sha256-3y21IwtVbxvJ52WxttOMFI/FQD3l76L/RZAaOIIX6+8=";
      version = "2.50.1.565.gc32cd1483b";
    ...
    master = {
      rev = "e4ef0485fd78fcb05866ea78df35796b904e4a8e";
      hash = "sha256-S86QVOmia+2wP/YTtyEYQwODnKNYukOnws5Rs5CI+rc=";
      version = "2.50.1.461.ge4ef0485fd";
      extraOverride = prevAttrs: {
        patches = map (
          p:
          if baseNameOf p == "git-send-email-honor-PATH.patch" then
