...
let
  baseData = {
    next = {
      rev = "d7d06c2dae85021966c6d9224e6b2efb4454bd77";
      hash = "sha256-e89rc5p39sZtdvdyW1IIPWJFmEHSHlJS9P5HujKAPHU=";
      version = "2.51.0.338.gd7d06c2dae";
    ...
    master = {
      rev = "f814da676ae46aac5be0a98b99373a76dee6cedb";
      hash = "sha256-qLVzOwdSWjB1xdslOa6Waud9zoq5zasocPNUlJCiLEM=";
      version = "2.51.0.122.gf814da676a";
      extraOverride = prevAttrs: {
        patches = [
