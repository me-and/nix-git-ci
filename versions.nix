...
let
  ...
  baseData = {
    next = {
      rev = "54b18a3513eed9ed5ced5c238ade55a434fd619a";
      hash = "sha256-fB/BeOGubcniNcUkSIi8OMWnSvm4X+h4tjW17icV6EA=";
      version = "2.53.0.rc2.235.g54b18a3513";
    ...
    master = {
      rev = "22584464849815268419fd9d2eba307362360db1";
      hash = "sha256-JTA4+jM6HfEfhdpkDxk6TZ0MErN108ct6jhCJNQ8uIA=";
      version = "2.53.0.rc2.2.g2258446484";
