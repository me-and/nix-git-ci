...
let
  ...
  baseData = {
    next = {
      rev = "6e5bcc1fc9a18b45bdea6554297c28759c7da2fc";
      hash = "sha256-dC+hlUc3jVQoVwCbDMpVW3uLztiLpoVD3HYI6mUJAtE=";
      version = "2.54.0.823.g6e5bcc1fc9";
    ...
    master = {
      rev = "1c00d2d8392f603a6263f11f1a50fde96ae5475e";
      hash = "sha256-0Z/Mwo2/l6RFW9TWsNDiiaktiurFf5v7IX10GyJydKk=";
      version = "2.54.0.198.g1c00d2d839";
