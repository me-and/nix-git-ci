...
let
  ...
  baseData = {
    next = {
      rev = "625c4fb2daac9879b299dd1cae2e793d2821dec0";
      hash = "sha256-nl/vqGfcjYVxFtHJx3pNFDZkYkoE4AxEOFQ+1NqH+ys=";
      version = "2.53.0.697.g625c4fb2da";
    ...
    master = {
      rev = "2cc71917514657b93014134350864f4849edfc83";
      hash = "sha256-69VydHnaU9YfUa4bK5gc58ZVFGR/Bpbsawyse8gYblQ=";
      version = "2.53.0.238.g2cc7191751";
