...
let
  baseData = {
    next = {
      rev = "0477971d2d8de6c8e9af5174e8d7dd1dc30410bc";
      hash = "sha256-rJbutVcQuf5OAPI6Ae70lccnaqw18t78nVaLz6K7y6k=";
      version = "2.51.1.952.g0477971d2d";
    ...
    master = {
      rev = "4e98b730f18d59b670ee57b803e5048b9d14b968";
      hash = "sha256-LCkCPUoWR+uXOp3A+3UYkxLcy4gLDSPyczvhzKYdCOs=";
      version = "2.51.1.549.g4e98b730f1";
      extraOverride = prevAttrs: {
        patches =
          map (
            p:
